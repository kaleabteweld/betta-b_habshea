...
$(function (){
    ...
    event_time_start.blur(function (e) { 
        ...
        if(init_time.length == 0){
            ...
            button_enable();
            event_time_start.addClass("is-invalid");
            event_time_start.attr("placeholder", "can not be empty");
        }else{
            ok.event_time_start = true;
            button_enable();
            event_time_start.removeClass("is-invalid");
            event_time_start.addClass("is-valid");
    ...
    event_time_end.blur(function (e) { 
        ...
        if(end_time.length == 0){
            ...
            button_enable();
            event_time_end.addClass("is-invalid");
            event_time_end.attr("placeholder", "can not be empty");
        }else{
            ok.event_time_end = true;
            button_enable();
            event_time_end.removeClass("is-invalid");
            event_time_end.addClass("is-valid");
    ...
    event_loc.blur(function (e) { 
        ...
        if(loc.length == 0){
            ok.event_loc = false;
            button_enable();
            event_loc.addClass("is-invalid");
            event_loc.attr("placeholder", "can not be empty");
        }else{
            ok.event_loc = true;
            button_enable();
            event_loc.removeClass("is-invalid");
            event_loc.addClass("is-valid");
